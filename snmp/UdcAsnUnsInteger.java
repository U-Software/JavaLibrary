/* *********************************************************************
 * @(#)UdcAsnUnsInteger.java 1.0, 18 Jan 2003
 *
...
/**
 * ASN1 UnsginedInteger型情報クラス。
 *
 * @author	Takayuki Uchida
 * @version	1.0, 18 Jan 2003
 * @since	UDC1.0
 */
public class UdcAsnUnsInteger extends UdcAsnObject
{
	/**
	 * unsigned int値。
	 * @since	UDC1.0
	 ...
	 * コンストラクタ
	 *
	 * @param	v	unsigned int値
	 * @since	UDC1.0
	 */
	public UdcAsnUnsInteger(long v)
	{
		this(v, TIMETICKS);
	}
	 ...
	 * @since	UDC1.0
	 */
	public UdcAsnUnsInteger(long v, byte t)
	{
		this.value = v;
		this.type = t;
	}
	 ...
	 * @since	UDC1.0
	 */
	public UdcAsnUnsInteger(InputStream in, int len) throws IOException
	{
		read(in,len);
	}
	...
	{
		return new UdcAsnUnsInteger(value,type);
	}
